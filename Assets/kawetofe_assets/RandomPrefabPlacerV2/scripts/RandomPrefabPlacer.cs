...
namespace kawetofe.randomPrefabPlacer
{
            ...
            if (prefabs.Count > 0)
            {
                ...
                while (picked == null)
                {
                    ...
                    if (randomPickNumber < prefabs[randomPrefabInt].possibility)
                    {
                        ...
                        // Vector3 scale = Vector3.Scale (originalPrefabScale, RandomScale (prefabs[randomPrefabInt]));
    ...
    public class PlacementPrefab : System.Object
    {
        ...
        public Vector3 lockedRotations = new Vector3 (1, 1, 0);
        [SerializeField]
